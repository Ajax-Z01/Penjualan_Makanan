                        ...
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                ...
                                <form role="form" action="<?= base_url; ?>/register/simpanuser" method="POST" enctype="multipart/form-data">
                                    ...
                                    <p class="text-center text-muted mt-3 mb-0">Have already an account? <a href="<?= base_url; ?>/login" class="fw-bold text-body"><u>Login here</u></a></p>
